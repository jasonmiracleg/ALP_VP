...
@Composable
fun SignInView(
    navController: NavController, dataStore: DataStoreManager, signInViewModel: SignInViewModel
) {
    ...
    Column(
        ...
        Button(
            onClick = { signInViewModel.logIn(email, password, navController, context, dataStore) },
